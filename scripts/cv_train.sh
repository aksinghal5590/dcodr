...
python -u $pyScript -onto $ontfile -gene2id $gene2idfile -cell2id $cell2idfile -train $traindatafile \
	...
	-std $stdfile -model $modeldir -genotype_hiddens 6 -lr 0.0005 -wd 0.0005 -cuda $cudaid \
	-epoch 200 -batchsize 64 -optimize 2 -zscore_method $zscore_method > "${modeldir}/train.log"
